...
export default function PersonalInfoConsent() {
  ...
  const isStandalone = location.pathname === "/terms/use";
  ...
  return (
    <div className="terms-container">
      <div className="terms-header">
        ...
        <h1 className="terms-title">이용약관 동의</h1>
      </div>
      <section className="terms-section">
        <h2>서비스 이용약관 (상품, 서비스 등 이용 일반 회원용)</h2>
        <h2>제1조 (목적)</h2>
        <p>
          1. 본 약관은 세끼통살이 운영하는 모바일 애플리케이션 '세끼통살'을 통해 제공되는 전자상거래 서비스와 관련하여 당사자의 권리 의무 및 책임사항을 규정하는 것을 목적으로 합니다.
      ...
      <section className="terms-section">
        ...
        <p>
          1. 본 약관에서 사용하는 용어의 정의는 다음과 같습니다.
            a. '회사'라 함은, 세끼통살이 재화 또는 용역을 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 상품을 거래할 수 있도록 설정한 가상의 영업장을 운영하는 주체를 말하며, 아울러 '세끼통살'을 통해 제공되는 전자상거래 관련 서비스의 의미로도 사용합니다.
            b. '모바일앱'이라 함은, '회사'가 개발 및 운영을 담당하고, '이용자'의 편의를 위하여 제공하는 모바일 애플리케이션을 말합니다.
            c. 본 조에서 정의되지 않은 본 약관 상의 용어는 일반적인 거래관행에 따라 해석합니다.
        </p>
      </section>
      ...
      <section className="terms-section">
        <h2>제4조 (약관의 명시 및 개정)</h2>
        <p>
          1. '회사'는 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지, 전화번호, 모사전송번호(FAX), 전자우편주소, 사업자등록번호, 통신판매업신고번호 등을 '이용자'가 쉽게 알 수 있도록 '사이트'의 초기 서비스화면에 게시합니다. 다만, 본 약관의 내용은 '이용자'가 연결화면을 통하여 확인할 수 있도록 할 수 있습니다.
          ...
          5. '회사'가 본 약관을 개정한 경우, 개정약관은 적용일자 이후 체결되는 계약에만 적용되며 적용일자 이전 체결된 계약은 개정 전 약관이 적용됩니다. 다만, 이미 계약을 체결한 '이용자'가 개정약관의 내용을 적용받고자 하는 뜻을 '회사'에게 전달하고, '회사'가 여기에 동의한 경우 개정약관을 적용합니다.
        </p>
      </section>
      ...
      <section className="terms-section">
        ...
        <p>
          ...
          4. '회사'의 서비스를 1년 동안 이용하지 않는 '회원'의 경우 휴면계정으로 전환하고 서비스 이용을 제한할 수 있습니다.
          5. 휴면계정 전환 시 계정 활성을 위해 필요한 아이디(ID), 비밀번호, 이름, 중복가입 방지를 위한 본인 인증값(DI), 휴대전화 번호를 제외한 나머지 정보는 삭제됩니다. 다만, 관계법령에 의해 보존할 필요가 있는 경우 '회사'는 정해진 기간 동안 회원정보를 보관합니다.
        </p>
      </section>

      <section className="terms-section">
        <h2>제8조(회원탈퇴 및 자격상실 등)</h2>
        <p>
      ...
      <section className="terms-section">
        ...
        <p>
          ...
          2. 시스템의 긴급점검, 증설, 교체, 시설의 보수 또는 공사를 위해 필요한 경우
          3. 시스템 또는 기타 서비스 설비의 장애, 유무선 Network 장애 등으로 정상적인 서비스 제공이 불가능한 경우
          4. 국가비상사태, 정전, 불가항력적 사유에 의한 경우
          5. '회사'는 '이용계약'의 체결, 계약사항의 변경 및 해지 등 '이용자'와의 계약관련 절차 및 내용 등에 있어 이용자에게 편의를 제공하도록 노력합니다.
          6. '회사'는 본 약관의 '상품의 판매가격 및 이용료'. '판매대금의 정산 및 지급' 규정에 따라 '판매회원'에게 대금을 정산할 의무를 부담합니다. 다만 본 약관의 '면책규정'에서 정하는 바와 같이 '판매회원'이 '일반회원'에게 제공한 서비스와 관련된 분쟁에 대하여는 책임을 부담하지 않습니다.
        </p>
      </section>
      ...
      <section className="terms-section">
        ...
        <p>
          ...
          2. '이용자'는 본 약관에서 규정하는 사항, '회사'가 정한 제반 규정, 기타 '회사'가 공지하는 사항을 준수하여야 합니다. 또한 '이용자'는 '회사'의 업무를 방해하는 행위 및 명예를 훼손하는 행위를 하여서는 안 됩니다.
          3. '이용자'는 주소, 연락처, 전자우편 주소 등 회원정보가 변경된 경우 즉시 온라인을 통하여 이를 수정해야 합니다. 변경된 정보를 수정하지 않거나 수정이 지연되어 발생하는 책임은 이용자가 부담합니다.
          4. '이용자'는 자신의 회원ID와 비밀번호를 직접 관리해야 합니다. '이용자'의 관리상의 부주의로 발생한 문제에 대하여는 '회사'가 책임을 부담하지 않습니다.
      ...
      <section className="terms-section">
        <h2>제12조(등록된 상품정보의 취소 및 삭제)</h2>
        <p>
          '공고 게시자'는 '전용화면'을 통해 상품 정보를 등록해야 합니다. 다만 '회사'는 다음 각호의 사유가 있는 경우 그 등록을 취소하거나 삭제할 수 있습니다.
            a. 상품등록양식에 어긋난 등록, 허위 및 중복 등록, 판매를 가장한 등록
            b. 중요 판매정보에 오기 또는 모순이 있는 등록
            c. 과다한 허위출고 또는 명백한 허위출고의 반복
            d. '공고 게시자'와 연락이 두절된 경우
            e. 기타 '회사'의 상품관련 서비스 비용이 과다하게 발생하는 경우
        </p>
      </section>

      <section className="terms-section">
        <h2>제13조(상품의 등록 및 관리)</h2>
        <p>
          1. '공고 게시자'는 '상품'에 관한 정보를 '전용화면'에서 직접 등록하여야 하며, 그 내용이 사실과 부합하도록 상시 관리하여야 합니다.
          2. '공고 게시자'는 '상품'의 가치에 영향을 미치는 정보에 대하여 그 진실성을 보장하여야 합니다. 표시된 '상품'의 정보에 허위사실이 있을 경우 그로 인한 모든 책임은 '공고 게시자'가 부담합니다.
        </p>
      </section>

      <section className="terms-section">
        <h2>제14조(상품의 판매 가격 및 이용료)</h2>
        <p>
          1. '회사'가 부과하는 '서비스 이용료'는 서비스 이용료, 기타 이용료로 구분됩니다. 각 서비스 및 서비스 이용료의 구체적인 내용은 해당 서비스화면에 별도로 게재합니다.
          2. '회사'는 필요한 경우 서비스이용료를 신설하거나 변경할 수 있으며, 그 내용은 '전용화면'을 통하여 통지합니다.
          3. 일반 회원은 회사의 서비스 이용대가로 수수료, 회원료 등 각 상품의 구매시 또는 별도로 회사가 정한 요율이나 기준에 따라 서비스 이용료를 회사에 지급해야 한다.
        </p>
      </section>

      <section className="terms-section">
        <h2>제15조(판매 부적합 상품)</h2>
        <p>
          1. '회사'는 관계법령 또는 일반 거래관행, 사회통념에 따라 개별적으로 판매부적합 상품 여부를 판단하여 제재할 수 있습니다.
          2. '공고 게시자'의 고의 또는 과실로 판매부적합 상품이 등록된 경우, '회사'는 즉시 해당 상품의 판매를 중지시키고 이 사실을 '공고 게시자'에게 통보합니다. 만약, '판매회원'의 고의에 의한 등록으로 판단될 경우 '회사'는 '이용계약'을 해지할 수 있습니다.
          3. '공고 게시자'의 고의 또는 과실로 판매부적합 상품이 판매된 경우, '회사'는 즉시 해당 상품의 판매를 중지하고 즉시 '이용계약'을 해지합니다. 이 때 '회사'는 필요한 경우 관계 기관에 위 사실을 즉시 신고할 수 있습니다.
          4. 판매부적합 상품을 등록한 경우 그 등록에 사용된 이용료 등 제반 비용은 환불되지 않으며, '공고 게시자'은 매매 부적합 물품의 등록 및 판매에 대한 모든 법적인 책임을 부담합니다.
        </p>
      </section>
      ...
      <section className="terms-section">
        ...
        <p>
          ...
          2. '회사'가 지급한 결제 가능한 쿠폰에 의한 결제
          3. 카카오페이
          4. '회사'는 '일반회원'이 결제수단에 대한 정당한 사용권한을 가지고 있는지 여부를 확인할 수 있으며, 이에 대한 확인이 완료될 때까지 거래 진행을 중지하거나, 확인이 불가능한 거래를 취소할 수 있습니다.
          5. '회사'의 정책 및 결제업체(이동통신사, 카드회사 등) 또는 결제대행업체(PG)의 기준에 따라 '일반회원' 당 월 누적 결제액 및 충전한도정당한 사용권한을 가지고 있는지 여부를 확인할 수 있으며, 이에 대한 확인이 완료될 때까지 거래 진행을 중지하거나, 확인이 불가능한 거래를 취소할 수 있습니다.
          6. '회사'의 정책 및 결제업체(이동통신사, 카드회사 등) 또는 결제대행업체(PG)의 기준에 따라 '일반회원' 당 월 누적 결제액 및 충전한도가 제한될 수 있습니다.
          7. 대금의 지급 또는 결제를 위하여 입력한 정보에 대한 책임은 '일반회원'이 전적으로 부담합니다.
        </p>
      </section>
      ...
      <section className="terms-section">
        <h2>제17조(청약철회)</h2>
        <p>
          1. '공고 게시자'과 재화 등의 구매에 관한 계약을 체결한 '일반회원'은 본 약관에 따른 수신확인의 통지를 받은 날 부터 7일 이내에 청약을 철회할 수 있습니다.
          2. 전항의 규정에도 불구하고 다음 각 호의 사유에 해당하는 경우, 배송받은 재화의 반품 또는 교환이 제한됩니다.
            a. '일반회원'에게 책임있는 사유로 상품이 멸실 또는 훼손된 경우(다만, 재화를 확인하기 위하여 포장 등을 훼손한 경우는 예외로 합니다)
            b. '일반회원'의 사용 또는 소비에 의하여 재화의 가치가 현저히 감소한 경우
            c. 시간의 경과로 재판매가 곤란할 정도로 재화의 가치가 현저히 감소한 경우
            d. 같은 성능을 지닌 재화 등으로 복제가 가능한 경우 그 원본이 되는 재화의 포장을 훼손한 경우
            e. '일반회원'의 주문에 의하여 개별적으로 생산한 제품으로서 청약철회 및 교환의 제한에 대하여 사전에 고지한 경우
          3. '공고 게시자' 또는 '회사'가 전 항의 청약철회 제한 사유를 '일반회원'가 알기 쉽게 명시하거나, 시용상품을 제공하는 등의 조치를 취하지 않은 경우 '구매자'의 청약철회가 제한되지 않습니다.
          4. 본조의 규정에도 불구하고, '일반회원'은 상품 등의 내용이 표시, 광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 상품을 공급받은 날로부터 3월 이내, 그 사실을 안날 또는 알 수 있었던 날로부터 30일 이내에 청약철회 등을 할 수 있습니다.
        </p>
      </section>

      <section className="terms-section">
        <h2>제18조(저작권의 귀속 및 이용)</h2>
        <p>
          1. '세끼통살'이 제공하는 서비스 및 관련된 모든 지식재산권은 '회사'에 귀속됩니다
          2. '이용자'는 '세끼통살'에게 지식재산권이 있는 정보를 사전 승낙없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나, 제3자가 이용하게 하여서는 안됩니다.
          ...
          4. 전항의 규정에도 불구하고 '회사'는 서비스의 운영, 전시, 전송, 배포, 홍보 등의 목적으로 별도의 허락 없이 무상으로 저작권법 및 공정한 거래관행에 합치되는 범위 내에서 다음 각호와 같이 '이용자'가 등록한 저작물을 이용할 수 있습니다.
            ...
            b. 서비스의 운영, 홍보, 서비스 개선 및 새로운 서비스 개발을 위한 범위내의 사용
            c. 미디어, 통신사 등을 통한 홍보목적으로 '콘텐츠'를 제공, 전시하도록 하는 등의 사용
        </p>
      </section>
