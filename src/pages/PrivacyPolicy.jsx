...
export default function PrivacyPolicy() {
  ...
  const isStandalone = location.pathname === "/terms/privacy";
  return (
    <div className="terms-container">
      ...
      <section className="terms-section">
        <h2>제1조(목적)</h2>
        <p>
          세끼통살 (이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
        </p>
      </section>
      ...
      <section className="terms-section">
        <h2>제10조(서비스 이용 및 부정 이용 확인을 위한 정보)</h2>
        <p>
      ...
      <section className="terms-section">
        ...
        <h2>제14조(사전동의 등에 따른 개인정보의 제공)</h2>
        <p>
          1. 회사는 개인정보 제3자 제공 금지에도 불구하고, 이용자가 사전에 공개하거나 다음 각호 사항에 대하여 동의한 경우에는 제3자에게 개인정보를 제공할 수 있습니다. 다만 이 경우에도 회사는 관련 법령 내에서 최소한으로 개인정보를 제공합니다.
            a. 타 이용자에게 서비스 제공을 위하여 이름, 연락처, 이메일을 제공
      ...
      <section className="terms-section">
        ...
        <h2>제16조(법령에 따른 개인정보의 보유 및 이용기간)</h2>
        <p>
      ...
      <section className="terms-section">
        ...
        <h2>제23조(개인정보 자동 수집 장치의 설치·운영 및
거부에 관한 사항)</h2>
        <p>
      ...
      <section className="terms-section">
        ...
        <h2>제25조(회사의 개인정보 보호 책임자 지정)</h2>
        <p>
          1. 회사는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보 보호 책임자를 지정하고 있습니다.
            a. 개인정보 보호 책임자
              i. 성명: 박가은
              ii. 직책: 프로젝트 팀장
              iii. 전화번호: 010-6619-3572
              iv. 이메일: rirponw@gmai.com
        </p>
      </section>

      <section className="terms-section">
        
        <h2>제26조(권익침해에 대한 구제방법)</h2>
        <p>
